...
class DeepSort(object):
    def __init__(self, model_type, max_dist=0.1, min_confidence=0.3, nms_max_overlap=1.0, max_iou_distance=0.7, max_age=30, n_init=3, nn_budget=100, use_cuda=True):
        ...
        if use_cuda is True:
            ...
            device = 'cpu'
        self.extractor = FeatureExtractor(model_type, device=device)

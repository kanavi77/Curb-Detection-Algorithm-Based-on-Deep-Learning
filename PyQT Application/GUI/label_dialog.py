...
class LabelDialog(QDialog):
    ...
    def __init__(self, id=0, text="Enter object label", parent=None, list_item=None):
        ...
        self.editId.setText(str(id))
        hLayoutId = QHBoxLayout()
        hLayoutId.addWidget(self.labelID)
        hLayoutId.addWidget(self.editId)
        ...
        self.labelText = QLabel("Label: ", self)
        hLayoutLabel = QHBoxLayout()
        hLayoutLabel.addWidget(self.labelText)
        hLayoutLabel.addWidget(self.edit)

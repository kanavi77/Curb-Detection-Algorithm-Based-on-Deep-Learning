...
class canvas(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.trackWorker = trackWorker(self)  
        self.trackWorker.sinOut.connect(self.update_track_status)
        self.fileWorker = fileWorker(self)  
    ...
    def returnframes(self):
        return self.trackWorker.imgFrames
     
    def load_frames(self):
        self.trackWorker.load_frames(self.imgFrames)  
        self.numFrames = len(self.imgFrames)  
    ...
    def track_frame(self):
        self.trackWorker.load_frames(self.imgFrames)
        self.trackWorker.load_model(self.window.currentModel,self.window.filePath)
